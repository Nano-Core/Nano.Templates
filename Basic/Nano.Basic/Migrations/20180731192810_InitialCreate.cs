        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFriendly = table.Column<bool>(nullable: false, defaultValue: true),
                    PhoneNumber_Number = table.Column<string>(maxLength: 20, nullable: true),
                    EmailAddress_Email = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Name_IsDeleted",
                table: "Person",
                columns: new[] { "Name", "IsDeleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Person_EmailAddress_Email",
                table: "Person",
                column: "EmailAddress_Email");

            migrationBuilder.CreateIndex(
                name: "IX_Person_PhoneNumber_Number",
                table: "Person",
